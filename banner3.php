...
<body style="background:#fff;">
    ...
    <div id="sliderb_container" style="position: relative; width: 500px;
        ...
        <!-- Slides Container -->
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 500px; height: 600px;
            overflow: hidden;">
            <div>
                <img u=image src="images/estatal.png" />
                <div u="thumb">Autorizacion Estatal</div>
            </div>
            <div>
                <img u=image src="images/municipal.png" />
                <div u="thumb">Autorizacion Municipal</div>
            </div>
