...
<body style="padding:0px; margin:0px; font-family:Arial, Verdana;background-color:#fff;">
    ...
    <div id="slider1_container" style="position: relative; margin: 0 auto;
        ...
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1300px;
            ...
            <div>
                <img u="image" src="images/gras2.jpg" /> <!-- jquery-slider-master/img/1920/red.jpg -->
                <div u="caption" t="NO" t3="RTT|2" r3="137.5%" du3="3000" d3="500" style="position: absolute; width: 445px; height: 300px; top: 100px; left: 600px;">
                    <img src="images/rrr2.png" style="position: absolute; width: 445px; height: 300px; top: 0px; left: 0px;" /> <!-- jquery-slider-master/img/new-site/c-phone.png -->
<!--                    <img u="caption" t="CLIP|LR" du="4000" t2="NO" src="images/planta.png" style="position: absolute; width: 102px; height: 78px; top: 70px; left: 130px;" />  jquery-slider-master/img/new-site/c-jssor-slider.png 
                    <img u="caption" t="ZMF|10" t2="NO" src="images/gif_recycle.gif" style="position: absolute; width: 80px; height: 53px; top: 153px; left: 163px;" />  jquery-slider-master/img/new-site/c-text.png 
                    <img u="caption" t="RTT|10" t2="NO" src="images/circuloT.png" style="position: absolute; width: 140px; height: 90px; top: 60px; left: 220px;" />  jquery-slider-master/img/new-site/c-fruit.png -->
                    <!--<img u="caption" t="T" du="4000" t2="NO" src="images/title.png" style="position: absolute; width: 300px; height: 155px; top: 57px; left: 121px;" />  jquery-slider-master/img/new-site/c-navigator.png -->
                </div>
                <div u="caption" t="RTT|2" r="-75%" du="1600" d="2500" t2="NO" style="position: absolute; width: 470px; height: 220px; top: 120px; left: 650px;">
                    <!--<img src="images/papelBlanco.png" style="position: absolute; width: 470px; height: 220px; top: 0px; left: 0px;" />  jquery-slider-master/img/new-site/c-phone-horizontal.png -->
                    <img u="caption" t3="MCLIP|L" du3="2000" src="images/mundoVerde.png" style="position: absolute; width: 379px; height: 213px; top: 4px; left: 45px;" /> <!-- jquery-slider-master/img/new-site/c-slide-1.jpg -->
                    <img u="caption" t="MCLIP|R" du="2000" t2="NO" src="images/mundoAzul.png" style="position: absolute; width: 379px; height: 213px; top: 4px; left: 45px;" /> <!-- jquery-slider-master/img/new-site/c-slide-3.jpg -->
                    <!--<img u="caption" t="RTTL|BR" x="500%" y="500%" du="1000" d="-3000" r="-30%" t3="L" x3="70%" du3="1600" src="jquery-slider-master/img/new-site/c-finger-pointing.png" style="position: absolute; width: 257px; height: 300px; top: 80px; left: 200px;" />-->
                    <!--<img src="jquery-slider-master/img/new-site/c-navigator-horizontal.png" style="position: absolute; width: 379px; height: 213px; top: 4px; left: 45px;" />-->
                </div>
                <div style="position: absolute; width: 480px; height: 120px; top: 30px; left: 30px; padding: 5px;
                    text-align: left; line-height: 60px; text-transform: uppercase; font-size: 50px;
                        color: #FFFFFF;">Recuparadora y Recicladora Rancho Seco
                </div>
                <div style="position: absolute; width: 480px; height: 120px; top: 300px; left: 30px; padding: 5px;
                    text-align: left; line-height: 36px; font-size: 25px;
                        color: #FFFFFF;">
                        Somos una empresa prestadora de servicios de recolección y transporte de todo tipo de scrap ferrosos, metálicos y residuos de manejo especial para su reciclaje o disposici&oacute;n.
                </div>
            </div>
            <div>
                <img u="image" src="images/hoja.jpg" /> <!-- jquery-slider-master/img/1920/purple.jpg -->
                <div style="position: absolute; width: 480px; height: 120px; top: 30px; left: 30px; padding: 5px;
                    text-align: left; line-height: 60px; text-transform: uppercase; font-size: 50px;
                        color: #FFFFFF;">Recuparadora y Recicladora Rancho Seco
                </div>
                <div style="position: absolute; width: 480px; height: 120px; top: 300px; left: 30px; padding: 5px;
                    text-align: left; line-height: 36px; font-size: 30px;
                        color: #FFFFFF;">
                        Recuperadora y Recicladora, se localiza en zona sur de la ciudad de Celaya, Gto.
                </div>
            </div>
            <div>
                <img u="image" src="images/gota.jpg" /> <!-- jquery-slider-master/img/1920/blue.jpg -->
                <div style="position: absolute; width: 480px; height: 120px; top: 30px; left: 30px; padding: 5px;
                    text-align: left; line-height: 60px; text-transform: uppercase; font-size: 50px;
                        color: #FFFFFF;">Recuparadora y Recicladora Rancho Seco
                </div>
                <div style="position: absolute; width: 480px; height: 120px; top: 300px; left: 30px; padding: 5px;
                    text-align: left; line-height: 36px; font-size: 25px;
                        color: #FFFFFF;">
                        La localización geográfica de recuperadora y recicladora rancho seco, nos permite brindarle un servicio oportuno, continuo y eficaz en la recolección, transportación y manejo de residuos.
                </div>
            </div>
            ...
            <style>
                .share-icon {
                    ...
                    background-image: url(jquery-slider-master/img/share/share-icons.png);
                }
        ...
        .share-stumbleupon {
            ...
            <div u="any" style="position: absolute; display: block; top: 6px; right: 170px; width: 280px; height: 40px;">
                ...
                <a class="share-icon share-facebook" target="_blank" href="index.php" title="Facebook"></a> <!-- http://www.facebook.com/sharer.php?u=http://jssor.com -->
                ...
                <a class="share-icon share-email"  href="mailto:paginaweb@pgweb.com" title=Email></a>
            </div>
        ...
        <style>
            ...
            */
            ...
            {
                background: url(jquery-slider-master/img/b21.png) no-repeat;
                overflow:hidden;
                cursor: pointer;
            }
        ...
        <style>
            ...
            */
            .jssora21l, .jssora21r, .jssora21ldn, .jssora21rdn
            {
            	...
            	cursor: pointer;
            	display: block;
                background: url(jquery-slider-master/img/a21.png) center center no-repeat;
                overflow: hidden;
            }
